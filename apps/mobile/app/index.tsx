...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: '#F6F8FB' }, content: { padding: 18, gap: 16, paddingBottom: 40 }, topActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 18 }, topLink: { color: '#2D6E9F', fontWeight: '800' },
