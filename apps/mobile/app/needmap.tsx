...
export default function NeedMap() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content}>
    ...
    <View style={styles.map}><Text style={styles.mapTitle}>Nearby community intelligence</Text><Text style={styles.mapText}>This surface now queries the live geospatial API. Interactive map tiles and clustered pins are the next visual layer; the underlying nearby data is no longer hard-coded.</Text></View>
