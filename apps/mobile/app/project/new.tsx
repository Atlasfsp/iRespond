...
export default function NewProject(){
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
    ...
    <View style={styles.row}><View style={styles.flex}><Field label="Estimated budget" value={budget} onChangeText={setBudget} keyboardType="decimal-pad"/></View><View style={styles.currency}><Field label="Currency" value={currency} onChangeText={(v)=>setCurrency(v.toUpperCase().slice(0,3))}/></View></View>
